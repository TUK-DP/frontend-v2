...
const MainDementiaPreventionSection = () => {
  return (
    <div className="flex justify-between my-8">
      <MainFeatureButton adverb={"간단한"} buttonName={"치매진단"} imgsrc={btn_survey} />
      <MainFeatureButton adverb={"하루기록"} buttonName={"일기장"} imgsrc={btn_diary} />
    </div>
  );
};

//메인기능 버튼 컴포넌트
const MainFeatureButton = ({adverb, buttonName, imgsrc}) => {
  return (
